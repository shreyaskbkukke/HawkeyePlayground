package com.hawkeye.gameModule.data.datastore
...
class AppSettingsManager(context: Context) {
    ...
    // app to authentication
    private val authenticUserKey = booleanPreferencesKey("authenticUser")
    ...
    val authenticUser = dataStore.data.map { preferences ->
        preferences[authenticUserKey] ?: true
    }
